...
setup(
    ...
    description='Energia rover behavior nodes and bridges',
    ...
    entry_points={
        'console_scripts': [
            ...
            'ultrasonic_gazebo_simulator = energia_bridge.ultrasonic_gazebo_simulator:main',
            'ultrasonic_bridge_sim = energia_bridge.ultrasonic_bridge_sim:main',
